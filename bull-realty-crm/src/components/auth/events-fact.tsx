...
/**
 * A line of trade knowledge under the headline, rotating a day at a time.
 *
 * The list is already about weddings — it was rewritten when the product was;
 * only the component's name and its label still said real estate, which is the
 * kind of leftover nobody notices until it is on the sign-in page of a
